        ...
        <div class="container">
            ...
            <ul class="ul_blue_nav">
                <li class="el_blue_nav">
                    <figure >
                        <img class="img_blue_nav" src="/img/buy-comics-digital-comics.png" alt="">
                    </figure>
                    <a href="#" class="a_blue_nav">Digital comics</a>
                </li>
                <li class="el_blue_nav">
                    <figure >
                        <img class="img_blue_nav" src="/img/buy-comics-merchandise.png" alt="">
                    </figure>
                    <a href="#" class="a_blue_nav">Dc merchandise</a>
                </li>
                <li class="el_blue_nav">
                    <figure >
                        <img class="img_blue_nav"  src="/img/buy-comics-shop-locator.png" alt="">
                    </figure>
                    <a href="#" class="a_blue_nav">Subscription</a>
                </li>
                <li class="el_blue_nav">
                    <figure>
                        <img class="img_blue_nav" src="/img/buy-comics-subscriptions.png" alt="">
                    </figure>
                    <a href="#" class="a_blue_nav">Comic shop locator</a>
                </li>
                <li class="el_blue_nav">
                    <figure >
                        <img class="img_blue_nav power_visa" src="/img/buy-dc-power-visa.svg" alt="">
                    </figure>
